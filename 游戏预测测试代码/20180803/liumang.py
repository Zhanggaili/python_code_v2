...
test_path = comman_path + r"data/original/test_no_7_no_45.csv"

save_path = comman_path + r"data/submit/result_no_7_no_45.csv"
...
if __name__ == "__main__":
    ...
    liumang = test_df.pay_price.apply(lambda x:0.99)
